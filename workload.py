...
input_bucket = "inputbucket-lasnubes"
output_bucket = "outputbucket-lasnubes"
#test_cases = "test_cases/"
test_cases = "test_cases\\"

def clear_input_bucket():
	global input_bucket
	s3 = boto3_client('s3', region_name='us-east-1', aws_access_key_id='xyz', aws_secret_access_key='abc')
